...
def contact_view(request: HttpRequest) -> HttpResponse:
    ...
    contact_jsonld = (
        '{"@type":"ContactPage","name":"Contact Axial Foundry",'
        '"url":"' + (settings.SITE_URL or '') + '/contact/",'
        '"about":{"@id":"' + (settings.SITE_URL or '') + '#organization"}}'
    )
    ...
    return render(
        ...
        'leads/contact.html',
        {
            'page_title': 'Contact \u2014 Start a Project',
            'meta_description': 'Tell Axial Foundry about your project. Software, AI systems, web development, and automation. Six focused questions, founder-led reply.',
            'og_title': 'Contact Axial Foundry',
            'og_description': 'Start a software, AI, or web development project with Axial Foundry. Founder-led, research-backed engineering.',
            'form': form,
            'submitted': submitted,
