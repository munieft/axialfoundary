...
POSITIONING_STATEMENT = (
    'We combine product thinking, modern engineering practice, and research-backed AI expertise '
    'to turn business needs into working digital systems. That means some engagements are advanced '
...
SERVICE_CLUSTERS = [
    {
        'slug': 'ai-systems',
        'title': 'AI Systems',
        'summary': 'Applied AI inside real products, support channels, and internal workflows.',
        'image': 'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1400&q=75',
        'items': [
    ...
    },
    {
        ...
        'summary': 'Premium digital presence for businesses that need credibility, speed, and stronger customer journeys.',
        'image': 'https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=1400&q=75',
        'items': [
    ...
    },
    {
        ...
        'summary': 'Operational systems that connect data, reduce repetitive work, and improve visibility.',
...
FEATURED_SOLUTIONS = [
    {
        ...
        'short': 'Brand-aligned assistant that answers, routes, and hands off cleanly.',
    ...
    },
    {
        ...
        'short': 'Turn scattered documents into a searchable working layer.',
    ...
    },
    {
        ...
        'short': 'Conversational layer connected to CRM, WhatsApp, and workflows.',
    ...
    },
    {
        ...
        'short': 'Reporting surface that keeps pipeline and exceptions visible.',
    ...
    },
    {
        ...
        'short': 'Modern, conversion-aware website that presents the business with authority.',
    ...
    },
    {
        ...
        'short': 'Remove repetitive admin work and connect the tools you depend on.',
    ...
    },
    {
        ...
        'short': 'Focused app for customers, partners, or internal teams.',
    ...
    },
    {
        ...
        'short': 'Transcription, diarization, or voice-enabled processing for real use cases.',
        ...
        'members': [
            {
                ...
                'bio': 'Builds production NLP and speech systems. Trained Urdu LLMs on 800M+ tokens with state-of-the-art results across 10 benchmark tasks. Ships RAG-powered assistants for government and enterprise contexts and ASR/TTS pipelines for low-resource languages. DAAD research fellow at Konstanz; trainer at University of Moratuwa; international delivery for clients across NYC, London, and India.',
                'avatar': 'avatar-1',
                'image' : "img/team/munief.jpeg",
                'links': [
                    {'label': 'LinkedIn', 'url': 'https://www.linkedin.com/in/munief-hassan/'},
                ],
            ...
            },
            {
                ...
                'links': [
                    {'label': 'LinkedIn', 'url': 'https://www.linkedin.com/in/hamza-ayoub/'},
                ],
            ...
            },
            {
                ...
                'image' : "img/team/amina.jpeg",
                'bio': 'Backend engineer with internship experience at Arbisoft. Builds Flask, Django, and NestJS services with REST and GraphQL contracts on PostgreSQL. Recent projects include an AI-driven resume checker, a Scrapy + Playwright + OpenAI directory pipeline, and a tested NestJS time-off microservice.',
                'avatar': 'avatar-4',
                'links': [],
        ...
        'members': [
            {
                ...
                'links': [
                    ...
                    {'label': 'GitHub', 'url': 'https://github.com/maham0612'},
                ],
                'tags': ['Next.js', 'TypeScript', 'AI agents', 'DevOps'],
            },
            {
                'name': 'Hadia Shahid',
            ...
            },
            {
                ...
                'links': [
                    ...
                    {'label': 'GitHub', 'url': 'https://github.com/sajid-munawar'},
                ],
                'tags': ['Frontend', 'Design-to-code', 'CSS'],
            },
        ],
    },
]
...
CASE_STUDIES = [
    {
        'slug': 'medical-distributor-whatsapp-assistant',
        'category': 'Applied AI · Conversational Systems',
        'title': 'CRM-connected WhatsApp assistant for a B2B medical equipment distributor',
        'sector': 'Healthcare distribution',
        'region': 'India',
        'year': '2024 – 2025',
        'featured': True,
        'summary': 'A multi-turn customer support assistant that handles enquiries on WhatsApp, grounds answers in product documentation, and stays connected to the distributor\u2019s sales workflow.',
        'challenge': 'The distributor\u2019s sales and support team was processing repetitive product enquiries, quote follow-ups, and order status questions across WhatsApp and email \u2014 with no central record, no automated triage, and inconsistent response times that slowed the sales pipeline.',
        'solution': 'Built a conversational assistant on Flask with OpenAI-powered logic, a retrieval layer over the distributor\u2019s product catalogue and FAQ corpus, and Twilio-driven WhatsApp delivery. Conversations were stored against contact records so the sales team could pick up where the assistant left off, and automated follow-up workflows were layered on top to keep slow-moving conversations active without manual prodding.',
        'deliverables': [
            'WhatsApp conversational layer with multi-turn context retention',
            'RAG over product catalogue and support documentation',
            'Flask backend with conversation storage and lead handoff',
            'Automated follow-up sequences for stalled conversations',
        ],
        'capabilities': ['OpenAI', 'RAG', 'Twilio / WhatsApp', 'Flask', 'CRM integration'],
        'outcome': 'Improved client engagement rates on follow-ups and removed manual triage from the sales team\u2019s daily workflow. The assistant operates as the first responder on the channel, escalating to humans when the question moves outside its scope.',
        'note': 'Client name withheld at their request. Engagement led by the studio\u2019s founding team prior to operating as Axial Foundry.',
    },
    {
        'slug': 'restaurant-intelligence-data-platform',
        'category': 'Data Infrastructure · Automation',
        'title': 'Large-scale data infrastructure for a restaurant intelligence platform',
        'sector': 'Hospitality intelligence',
        'region': 'United Kingdom',
        'year': '2023 – 2024',
        'featured': True,
        'summary': 'A scraping and monitoring layer collecting structured data on more than one million restaurants, with operational dashboards built so the client\u2019s team could see pipeline health at a glance.',
        'challenge': 'The platform needed continually-refreshed structured data on a very large set of hospitality venues sourced from public listings. Existing collection was brittle, single-threaded, and offered no visibility \u2014 silent failures and partial scrapes were corrupting downstream analytics.',
        'solution': 'Engineered a scraping infrastructure capable of running across the 1M+ venue set, hardened against rate limits and structure changes. Built Django-based monitoring dashboards backed by SQL so the operations team could watch run health, freshness, and exception rates in real time. Data was normalised on ingestion and surfaced cleanly to the client\u2019s analytics layer.',
        'deliverables': [
            'Scraping pipeline tuned for 1M+ records and resilient to source-side changes',
            'Django monitoring dashboards with run health, freshness, and exception views',
            'SQL data layer with normalisation and deduplication on ingest',
            'Operational runbook and alerting hooks for pipeline failures',
        ],
        'capabilities': ['Selenium', 'Django', 'SQL', 'Data pipelines', 'Monitoring dashboards'],
        'outcome': 'Replaced an unreliable collection setup with infrastructure the client could trust at scale. Pipeline visibility shifted from \u201cnothing came in today, why?\u201d to a dashboard view of every run\u2019s health.',
        'note': 'Client name withheld. Engagement led by the studio\u2019s founding team prior to operating as Axial Foundry.',
    },
    {
        'slug': 'knowledge-assistant',
        'category': 'AI Systems',
